      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+1.2% desde ontem</p>
          </CardContent>
        </Card>
      </div>

      <div className="grid gap-4 md:gap-8 lg:grid-cols-2 xl:grid-cols-3 mt-4">
        {/* Futuramente colocaremos um gráfico e a lista de eventos recentes aqui */}
        <Card className="xl:col-span-2">
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground text-center py-10 border-2 border-dashed rounded-lg">
              O gráfico de vendas aparecerá aqui.
            </div>
          </CardContent>
        </Card>
      </div>
